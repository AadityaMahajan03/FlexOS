...
const HandGestures = ({ onNavigate }) => {
    ...
    const equipmentItems = [
        {
            name: "AirSlide",
            description: "Hand Based Presentation Controller",
            ...
            apiEndpoint: "http://127.0.0.1:5000/presentationcontroller/start"  // API to start the virtual mouse

        },
        {
            name: "PhantomCursor",
            description: "Hand Based Mouse",
            icon: <Mouse className="w-16 h-16" strokeWidth={1} />,
            color: "from-purple-950/40 via-purple-800/20 to-purple-950/40",
            glow: "purple",
            indicators: ['purple', 'purple', 'blue', 'blue'],
            apiEndpoint: "http://127.0.0.1:5000/activate-vm"  // API to start the virtual mouse

        },
        {
            name: "SignSwitch",
            description: "Sign Language For People",
            icon: <Layout className="w-16 h-16" strokeWidth={1} />,
            color: "from-emerald-950/40 via-emerald-800/20 to-emerald-950/40",
            glow: "emerald",
            indicators: ['green', 'blue', 'green'],
            apiEndpoint: "http://127.0.0.1:5000/signlanguage/start"  // API to start the virtual mouse

        },
        {
            name: "AirLift",
            description: "Hand Gesture Based Drag and Drop Control",
            icon: <Move className="w-16 h-16" strokeWidth={1} />,
            color: "from-amber-950/40 via-amber-800/20 to-amber-950/40",
            glow: "amber",
            indicators: ['yellow', 'yellow', 'red', 'yellow'],
            apiEndpoint: "http://127.0.0.1:5000/draganddrop/start"  // API to start the virtual mouse

        },
        {
            name: "GlideScroll",
            description: "Hand Gesture Based Scroll",
            icon: <ScrollText className="w-16 h-16" strokeWidth={1} />,
            color: "from-red-950/40 via-red-800/20 to-red-950/40",
            glow: "red",
            indicators: ['red', 'purple', 'red'],
            apiEndpoint: "http://127.0.0.1:5000/gesture-scroll/start"  // API to start the virtual mouse
        },
        {
            name: "PinchZoom XR",
            description: "Hand Gesture Based Zoomer",
            icon: <ZoomIn className="w-16 h-16" strokeWidth={1} />,
            color: "from-blue-950/40 via-blue-800/20 to-blue-950/40",
            glow: "blue",
            indicators: ['blue', 'cyan', 'blue', 'cyan']
