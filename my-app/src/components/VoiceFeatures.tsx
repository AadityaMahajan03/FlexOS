...
const VoiceFeatures = ({ onNavigate }) => {
    ...
    const equipmentItems = [
        {
            name: "Path Navigator",
            description: "Allows the Person to get Directions from the user",
            ...
            apiEndpoint: "http://127.0.0.1:5000/pathnavigator/start"  // API to start the virtual mouse

        },
        {
            name: "AI Voice Assistant",
            description: "Cool Voice Based Personal Assistant",
        ...
        {
            name: "PDF Reader",
            description: "Real Time PDF Reader",
