...
const FacialFeatures = ({ onNavigate }) => {
    ...
    const equipmentItems = [
        {
            name: "Remember the Face",
            description: "AI-Powered Facial Rememberance",
        ...
        },
        {
            ...
            description: "Real-time Facial Recognition",
            ...
            apiEndpoint: "http://127.0.0.1:5000/facerecognition/start"  // API to start the virtual mouse
        },
        {
            name: "Interactive Reader",
            description: "Dynamic Text Size Changer",
            ...
            apiEndpoint: "http://127.0.0.1:5000/interactivereading/start"  // API to start the virtual mouse
